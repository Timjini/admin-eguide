        ...
        <div className="mt-24 mt-auto">
          {loading && (
            <div className="flex flex-row justify-end">
              <button
                disabled
                type="button"
                className="py-2.5 px-5 me-2 text-sm font-medium rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 inline-flex items-center"
              >
                <svg
                  aria-hidden="true"
                  role="status"
          ...
          {!loading && (
            <div className="flex flex-row justify-between">
              <button
                type="submit"
                className="primaryBtn font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
              >
                Add A Tour
              </button>
            </div>
