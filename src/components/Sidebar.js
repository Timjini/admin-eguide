  ...
  return (
    <div>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        className="inline-flex items-center p-2 mt-2 ml-3 text-sm  rounded-lg sm:hidden  focus:outline-none focus:ring-2 focus:ring-gray-200  dark:focus:ring-gray-600"
      >
